        ...
        <div className="flex justify-center items-center">
          <div className="p-10 max-w-sm flex flex-col items-center justify-center">
            <div className="flex flex-col justify-start">
              ...
              <p className="text-gray-500 mb-10">
                Opss, a página que você procura foi movida, excluida, renomeada
                ou talvez nunca existiu!
              </p>
              <Link
                className="bg-azul-hyde w-2/3 text-center p-2 px-10 text-white font-semibold rounded-xl"
                to="/"
              >
          ...
          <div className="hidden w-80 h-80 lg:flex justify-center items-center">
            <img
              ...
              src={Notfound}
              alt="Rôbo quebrado com mensagem de erro 404"
            />
